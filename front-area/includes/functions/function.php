<?php
   ...
   /*
   ** Note => I'm Put Version To Every Function Becuse If I Want Renew This Function In The Future
...
/*
    ...
    //   ** Function To Get All Records Fron Any Database Table
        ...
        function getAllFrom($tableName, $orderBY, $where = NULL) {
           ...
           //  $sq1 = $where == NULL ? '' : $where;    => if المختصرة
...
/* ================================================================================================== */
       ...
       ** فنكشن لعرض لجلب الأقسام فقط من قاعدة البيانات
       */
       ...
       /*
       ** Check If User Is Not Acivated v1.0
       ** Function To Check The RegStatus Of The User
       **  لفحص حالة المستخدم هل هو مفعل أم لا
       */
       ...
       */
        ...
        function getItems($where, $value, $approve = NULL) {
            ...
            $getItem = $con->prepare("SELECT * FROM  items WHERE $where = ? $sql ORDER BY Item_ID ASC");
